...
import { ArticleType, CommentType, NewsStore } from "./NewsStore";
...
const StoreContext = createContext<NewsStore | undefined>(undefined);
...
export const StoreProvider = ({ children, fetchedData }: Provider) => {
  const store = initializeNewsStore(fetchedData);

  return <StoreContext.Provider value={store}>{children}</StoreContext.Provider>;
};

export let newsStore: NewsStore;
const initializeNewsStore = (fetchedData: FetchedData | null = null) => {
